...
Yield data will be collected as estimated yield (grain yield at 14\% moisture). They will be measured from average harvested grains from randomly selected three crop cut 5 $\mathrm{m}^{2}$ (2 $\times$ 2.5 meters) and dried to 14\% moisture content.
...
The R packages: \textbf{igraph} \shortcite{Csardi:2010wx}; \textbf{qgraph} \shortcite{qgraph}; \textbf{statnet} \shortcite{statnetpackage} and \textbf{network} \shortcite{networkpackage}; and \textbf{sna} \shortcite{snapackage} will be used to construct and analyze network models.
