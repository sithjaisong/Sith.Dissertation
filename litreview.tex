s% Your punctuation is still lacking. There are no spaces after a "(" or before a ")" or closing punctuation mark at the end of a sentence. Correct throughout.
%=====================================================================================
% Literature 
...
% The following is confusing. You state that most species don't affect rice production, but then go on to say that they are beneficial, which would mean that they DO affect rice production. Please consider your statement and revise. "Most of these species do not affect the rice production. They actually benefit with rice plants, such as predators, parasitoids, flowering plants, and soil bacteria \citep{norton2010rice}."

Rice fields are humman-managed ecosystems, which harbor diverse communities of plant, animal, and microbial species. Most of these species do not affect the rice production. They actually benefit with rice plants, such as predators, parasitoids, flowering plants, and soil bacteria \citep{norton2010rice}. However, there are some species threatening plant health and maybe reducing the productions mostly when their occurrences are in high level.
...
Bakanae, caused by \textit{Gibberella fujikuroi}, is commonly found throughout the whole growth stages of the rice plant. Infected seedlings elongates abnormally, becomes slender and the leaves turn pale yellow green. Infested plants develop roots at the upper nodes and the whole plant turns yellow. At booting stage, some infected plants die. 
...
% yellowing and dry what?
% don't forget your "," before the word "which"
% "mid-vain"? What does that mean?
% Revise this paragraph for accuracy and clarity. This disease is important in more places than just India.
...
% pathogen?
Bacterial leaf streak}symptoms begin with fine translucent streak between veins. As the disease progresses, the streaks becomes yellowish-gray, the lesions coalesce, then eventually turn to brown to grayish white causing the leaves to die.
...
\centering
% epidemiological tetrahedron? This is a new term which I am unfamiliar with. I would suggest following Zadoks' terminology.
...
% each type is plural, "is", is not plural, please use proper conjugations
...
% capitalization and punctuation of your list.
...
% is this epidemiological research? be specific!
% revise for grammar
...
% Revise for punctuation and capitalization and clarity
...
% your section and TOC have different capitalisation styles?
...
% your subsection and TOC have different capitalisation styles?
...
%%% First sentence is still, STILL unclear
...
% \paragraph{} is structurally preferred here, I think
...
% This summary is too short. You say nothing of the pests and diseases themselves, their impacts or not on yield and how network analysis can be used to help understand them
\section*{Summary}
