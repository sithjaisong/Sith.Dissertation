...
Speaking of crop health studies in rice in South and Southeast Asia, there are several article and reviews that discuss the topic \cite{savary2005multiple, Savary:2006to, Savary:2000vr, reddy2011characterizing, dong2010characterization}. 

% what is "’"?
% The sentence that starts with "The researchers aimed to characterize" is confusing and unclear.
% farmers� filed what? taxes?
% what does this mean, "and vary socioeconomic system"?
...
% chi-squre?
% you mention injury profiles and then define it later in the para. revise.
...
% india?
% Revise first sentence, you refer to data that's not been introduced yet. Awkward.
% Is the last sentence your words or something that Serge wrote in the paper?
...
% your verb tense is incorrect here
...
% You did not answer my question. If I leave a question, I expect an answer.
...
% Shouldn't this come at the beginning of the chapter?
